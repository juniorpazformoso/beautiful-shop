...
EXTRA_MODEL_FIELDS = (
    (
        "mezzanine.generic.models.ThreadedComment.phone",
        "CharField", # 'django.db.models.' is implied if path is omitted.
        (_("Phone"),),
        {"max_length": 255, 'blank': True, 'null': True},
    ),
    (
        "cartridge.shop.models.ProductImage.texture",
        "mezzanine.core.fields.FileField", # 'django.db.models.' is implied if path is omitted.
        (_("Texture"),),
        {"upload_to": "texture_image", "null": True, 'blank': True}
    ),
    (
        "cartridge.shop.models.ProductImage.number",
        "CharField", # 'django.db.models.' is implied if path is omitted.
        (_("Number"),),
        {"max_length": 20, 'blank': True, 'null': True},
    ),
    # (
    #     "cartridge.shop.models.Category.short_description_listing",
    #     "CharField",
    #     (_("Short Description Listing"),),
    #     {"max_length": 255, 'blank': True, 'null': True},
    # ),
    (
        "cartridge.shop.models.Category.short_text",
        "CharField", # 'django.db.models.' is implied if path is omitted.
        (_("Short description"),),
        {"max_length": 255, 'blank': True, 'null': True},
    ),
    (
        "cartridge.shop.models.ProductImage.color",
        "CharField", # 'django.db.models.' is implied if path is omitted.
        (_("Color"),),
        {"max_length": 255, 'blank': True, 'null': True},
    ),
    (
        "cartridge.shop.models.Product.artext",
        "CharField", # 'django.db.models.' is implied if path is omitted.
        (_("Artext"),),
        {"max_length": 255, "default": ''},
    ),
    (
        "cartridge.shop.models.Product.short_description",
        "CharField", # 'django.db.models.' is implied if path is omitted.
        (_("Short description"),),
        {"max_length": 255, "default": ''},
    ),
    (
        "cartridge.shop.models.Product.short_description_listing",
        "CharField",
        (_("Short Description Listing"),),
        {"max_length": 255, 'blank': True, 'null': True},
    ),
    (
        "cartridge.shop.models.Product.plus_content",
        "TextField", # 'django.db.models.' is implied if path is omitted.
        (_("Plus"),),
        {"default": ''},
    ),
    (
        "cartridge.shop.models.Product.ingredients",
        "TextField", # 'django.db.models.' is implied if path is omitted.
        (_("Ingredients"),),
        {"default": ''},
    ),
    (
        "cartridge.shop.models.Product.new_product",
    ...
    (
        "cartridge.shop.models.Product.limited_edition",
        "BooleanField", # 'django.db.models.' is implied if path is omitted.
        (_("Limited Edition"),),
        {"default": False},
    ),
    ...
    # ),
    # (
    #     "cartridge.shop.models.Product.composition",
    #     "TextField", # 'django.db.models.' is implied if path is omitted.
    #     (_("Composition"),),
    #     {"default": ''},
    # ),
    # (
    #     "cartridge.shop.models.Product.application",
    #     "TextField", # 'django.db.models.' is implied if path is omitted.
    #     (_("Application"),),
    #     {"default": ''},
    # ),
...
COMMENTS_APP = "apps.icona_comments"
COMMENT_FORM_CLASS = 'apps.icona_comments.forms.ThreadedCommentWithPhoneForm'
COMMENTS_DEFAULT_APPROVED=True
COMMENTS_NOTIFICATION_EMAILS=""
COMMENT_FILTER=False
COMMENTS_NUM_LATEST=12
...
EMAIL_HOST_PASSWORD = ""
#EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = "Icona <email@sample.com>"
EMAIL_PORT = 26
